# gitea-operator
This operator is intended for controlling Gitea from Kubernetes.

## Description
Controlling Gitea through CRDs gives the possibility for maintaining Gitea resources through GitOps.
