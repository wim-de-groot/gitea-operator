...
import (
	...
	"github.com/wim-de-groot/gitea-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(corealphav1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "bdf43b81.gitea.com",
	...
	if err := (&controller.GiteaReconciler{
		...
		Recorder: mgr.GetEventRecorder("gitea-operator"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "Gitea")
		os.Exit(1)
	}
	if err := (&controller.GiteaRepoReconciler{
		Client:   mgr.GetClient(),
		Scheme:   mgr.GetScheme(),
		Recorder: mgr.GetEventRecorder("gitea-operator"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "GiteaRepo")
		os.Exit(1)
	}
